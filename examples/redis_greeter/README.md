...
The example demonstrates the same features as the ['greeter'](https://github.com/pantheon-lab/go-care/tree/main/examples/greeter)
example, but uses Redis like an external cache.

All cases are equal to the ['greeter'](https://github.com/pantheon-lab/go-care/tree/main/examples/greeter) example.  
